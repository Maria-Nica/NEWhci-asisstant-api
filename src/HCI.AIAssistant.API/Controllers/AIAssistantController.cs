...
public class AIAssistantController : ControllerBase
{
    ...
    [HttpPost("message")]
    [ProducesResponseType(typeof(AIAsisstantControllerPostMessageResponseDTO), 200)]
    [ProducesResponseType(typeof(ErrorResponseDTO), 400)]
    public async Task<ActionResult> PostMessage([FromBody] AIAsisstantControllerPostMessageRequestDTO request)
    {
